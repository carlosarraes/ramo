...
pub struct ReviewFlags {
    ...
    #[arg(long, overrides_with = "no_tests_last")]
    pub tests_last: bool,
    #[arg(long, overrides_with = "tests_last")]
    pub no_tests_last: bool,
    #[arg(long, overrides_with = "no_ask")]
    pub ask: bool,
    #[arg(long, overrides_with = "ask")]
    pub no_ask: bool,
}
