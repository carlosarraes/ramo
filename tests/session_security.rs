...
#[test]
fn environment_resolution_prefers_pdiff_names_and_validates_ports() {
    let env = HashMap::from([
        ("PDIFF_SESSION_HOST".to_owned(), "localhost".to_owned()),
        ("PDIFF_SESSION_PORT".to_owned(), "48123".to_owned()),
    ...
    let bad = HashMap::from([("PDIFF_SESSION_PORT".to_owned(), "nope".to_owned())]);
